...
<head>
    ...
    <title>@yield("title","Zehra Sena Akgül | Kişisel Websitesi")</title>
                ...
                <div class="container-fluid">
                    <div class="header-navbar">
                        <div class="header-logo">
                            <a href="anasayfa"><img class="light-version-logo" src="{{asset("assets/frontend/media/logo-2.svg")}}"  alt="logo"></a>
                            <a href="anasayfa"><img class="dark-version-logo" src="{{asset("assets/frontend/media/logo-3.svg")}}"  alt="logo"></a>
                        </div>
                                ...
                                <div class="d-block d-lg-none">
                                    <div class="mobile-nav-header">
                                        <div class="mobile-nav-logo">
                                            <a href="anasayfa">
                                                <img class="light-mode" src="{{asset("assets/frontend/media/logo-.svg")}}"  alt="Site Logo">
                                                <img class="dark-mode" src="{{asset("assets/frontend/media/logo-.svg")}}"  alt="Site Logo">
                                            </a>
                                        </div>
